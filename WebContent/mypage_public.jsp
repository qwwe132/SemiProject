	...
	<body>
		...
		<div class="board_wrap">
	        ...
	        <div class="tab_list">
	            ...
	            <button class="btn-list" style="vertical-align: middle;" onclick="location.href='InfoController.do?command=myself&user_id=${user_list.user_id }'">작성한 글 확인</button>
	            ...
	            <button class="btn-list" style="vertical-align: middle;" onclick="open_win('PayController.do?command=pay_list&pay_user=${user_list.user_id }');">결제내역</button>
